...
"""
def find_room_number(height, weight, number):
    for w in range(weight):
        for h in range(1, height + 1, 1):
            if number == w * height + h:
                return str(h)+str(w+1).zfill(2)


if __name__ == '__main__':
    case = int(input())
    for i in range(case):
        height, weight, number = map(int, input().split())
        print(find_room_number(height, weight, number))
"""
...
if __name__ == '__main__':
    ...
    for i in range(case):
        ...
        room_h = number % height
        room_w = int(number / height) + 1
        if room_h == 0:
            room_h = height
            room_w = int(number / height)

        print(str(room_h)+str(room_w).zfill(2))
